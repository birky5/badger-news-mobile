[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=10747512&assignment_repo_type=AssignmentRepo)
...
- In Badger News, instead of having previous and next buttons to navigate between items, we are using a ScrollView instead. In my opinion this makes the application vastly easier to use. Also, just generally there is way less buttons that a user has to click to be able to use the application.
...
- One type of perceptible affordance is that each article is laid out in a card style and it is elevated, signifies that it is clickable and more information to be looked at. A type of hidden affordance that we could implement would be shake to refresh the articles if we had an API that continually updated the articles that were being returned.
...
- Change the icons in the application to be a metaphor for what is on that page, such as a gear for the preferences tab, and an outline of a newspaper for the news tab. Benefits to this are people would just be able to look at the icons and not the words to get an understanding of what might be on the next page. I do not believe that there would really be any consequences for this, other than people might perceive the icons differently or not "guess" right what an icon is actually symbolizing.
...
- Our business goal is to provide information about UW to people interested in the most recent news happening here at UW. The posture level of this application is that it is a news aggregator application for all news about UW. A user may be trying to find information about specific interests. This is supported in the application by allowing the user to be able to set their preferences and interests to show only information that they want to see.
